      ...
      {scheduleDoctorId ? (
        <>
          ...
          {dayEditorWeekday && !isPastWeekSelected && !isPastDayEditorSelected ? (
            <div className="fixed inset-0 z-30 flex items-center justify-center bg-[#10263a]/40 px-4">
              <div className="w-full max-w-5xl rounded-xl border border-[#c6d7e5] bg-white p-4 shadow-xl">
                <div className="flex items-center justify-between">
